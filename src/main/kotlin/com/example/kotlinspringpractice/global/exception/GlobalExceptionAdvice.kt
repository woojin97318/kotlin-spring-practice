...
class GlobalExceptionAdvice {
    ...
    fun handleCustomException(e: CustomException, request: HttpServletRequest): ErrorResponse {
        log.error(e) { "CustomException occurred: ${e.message}" }
        return createErrorResponse(request, e.errorMessage)
    }
    ...
    fun handleNoHandlerFound(e: NoHandlerFoundException, request: HttpServletRequest): ErrorResponse {
        log.error(e) { "NoHandlerFoundException occurred: ${e.message}" }
        return createErrorResponse(request, ErrorMessage.NOT_FOUND)
    }
    ...
    fun handleValidationExceptions(e: MethodArgumentNotValidException, request: HttpServletRequest): ErrorResponse {
        ...
        log.error(e) { "MethodArgumentNotValidException occurred: $message" }
    ...
    fun handleConstraintViolationException(
        ...
        log.error(e) { "ConstraintViolationException occurred: $message" }
    ...
    fun handleDataIntegrityViolation(e: DataIntegrityViolationException, request: HttpServletRequest): ErrorResponse {
        log.error(e) { "DataIntegrityViolationException occurred: ${e.message}" }
        return createErrorResponse(request, ErrorMessage.DATA_INTEGRITY_ERROR)
    }
    ...
    fun handleAccessDeniedException(e: AccessDeniedException, request: HttpServletRequest): ErrorResponse {
        log.error(e) { "AccessDeniedException occurred: ${e.message}" }
        return createErrorResponse(request, ErrorMessage.FORBIDDEN)
    }
    ...
    fun handleException(e: Exception, request: HttpServletRequest): ErrorResponse {
        ...
        return createErrorResponse(request, ErrorMessage.INTERNAL_SERVER_ERROR)
    }
}