...
class GlobalExceptionAdvice {
    ...
    fun handleCustomException(e: CustomException): ErrorResponse =
        createErrorResponse(e.errorMessage)
    ...
    fun handleNoHandlerFound(e: NoHandlerFoundException): ErrorResponse =
        createErrorResponse(ErrorMessage.NOT_FOUND)
    ...
    fun handleDataIntegrityViolation(e: DataIntegrityViolationException): ErrorResponse =
        createErrorResponse(ErrorMessage.DATA_INTEGRITY_ERROR)
    ...
    fun handleAccessDeniedException(e: AccessDeniedException): ErrorResponse =
        createErrorResponse(ErrorMessage.FORBIDDEN)
    ...
    fun handleException(e: Exception): ErrorResponse =
        createErrorResponse(ErrorMessage.INTERNAL_SERVER_ERROR)
}